...
" NOTE: Kamushin added this
" lambda s : s + 1 
" s should be a pythonParameters
" TODO
"syn match pythonlambdaExp "\%(lambda\s)" contained contains=pythonlambdaParameters 
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonMagic Structure
  HiLink pythonlambdaParameters Identifier
  "
